...
local placeDock = function(c, m) user.dock_pos(c, {margins = dpi(m)}) end
...
local dock = function(s)
    ...
    local createDockIndicators = function(data)
        ...
        return wibox.widget {
            {
                {indicators, spacing = user.spacing, layout = layout},
    ...
    local createDockElement = function(data)
        ...
        local customIcons = {
            ...
            {name = 'kitty', convert = 'gnome-terminal', command = 'kitty'}
        }
                ...
                {
                    {
                        ...
                        clip_shape = user.style == 'rounded' and
                            helpers.rrect(8),
    ...
    local createDockElements = function()
        ...
        local metadata = {
            ...
            {count = 0, id = 2, clients = {}, name = 'kitty', class = 'kitty'},
            {
                count = 0,
                id = 3,
                clients = {},
        ...
        local classes = {
            'discord', 'kitty', 'firefox', 'spotify', 'prismlauncher'
        }
        local dockElements = wibox.widget {
            layout = layout,
